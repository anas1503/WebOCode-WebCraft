...
const GameCards = () => {
  ...
  <div class="carousel-indicators">
    ...
    <button className="my-0 disabled" type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="1" aria-label="Slide 2"></button>
...
//                <div class="card" style={{ width: "18rem", height: "23rem" }}>
//                     <img src="/assets/images/Valorant.png" class="card-img-top" style={{ width: "100%", height: "23rem",borderRadius:"6px" }} alt="..." />
//                     <div class="card-body px-0">
//     <p class="card-text"><span style={{color:"#F94453"}}>VALORANT</span> | Defy the Limits </p>
//   </div>
//                 </div>
//                 </div>
//                 <div className="col-sm-3 py-3 py-sm-0">             
...
//                 <div class="card" style={{ width: "18rem", height: "23rem" }}>
//                     <img src="/assets/images/pubg.png" class="card-img-top" style={{ width: "100%", height: "23rem" }} alt="..." />
//                     <div class="card-body px-0">
//     <p class="card-text"><span style={{color:"#F94453"}}>PUBG</span> | Kill or be Killed </p>
//   </div>
//                 </div>
//                 </div>
...
//                 <div className="col-sm-3 py-3 py-sm-0">             
//                 <div class="card" style={{ width: "18rem", height: "23rem" }}>
//                     <img src="/assets/images/lastofus.png" class="card-img-top" style={{ width: "100%", height: "23rem" }} alt="..." />
//                     <div class="card-body px-0">
//     <p class="card-text"><span style={{color:"#F94453"}}>THE LAST OF US 2</span> | Survive to live</p>
//   </div>
//                 </div>
//                 </div>
...
//                 <div className="col-sm-3 py-3 py-sm-0">             
//                 <div class="card" style={{ width: "18rem", height: "23rem" }}>
//                     <img src="/assets/images/GTA5.png" class="card-img-top" style={{ width: "100%", height: "23rem" }} alt="..." />
//                     <div class="card-body px-0">
//     <p class="card-text"><span style={{color:"#F94453"}}>GTA V</span> | Thug Life</p>
//   </div>
//                 </div>
//                 </div>
                /* <div className="col-sm-3 py-3 py-sm-0">             
                <div class="card my-5" style={{ width: "18rem", height: "23rem" }}>
                    <img src="/assets/images/daysgone.png" class="card-img-top" style={{ width: "100%", height: "23rem" }} alt="..." />
                    <div class="card-body">
    <p class="card-text"></p>
  </div>
                </div>
                ...
                <div className="col-sm-3 py-3 py-sm-0">             
                <div class="card  my-5" style={{ width: "18rem", height: "23rem" }}>
                    <img src="/assets/images/cyberpunk.png" class="card-img-top" style={{ width: "100%", height: "23rem" }} alt="..." />
                    <div class="card-body">
    <p class="card-text"></p>
  </div>
                </div>
                ...
                <div className="col-sm-3 py-3 py-sm-0">             
                <div class="card  my-5" style={{ width: "18rem", height: "23rem" }}>
                    <img src="/assets/images/battlefield.png" class="card-img-top" style={{ width: "100%", height: "23rem" }} alt="..." />
                    <div class="card-body">
    <p class="card-text"></p>
  </div>
                </div>
                ...
                <div className="col-sm-3 py-3 py-sm-0">             
                <div class="card  my-5" style={{ width: "18rem", height: "23rem" }}>
                    <img src="/assets/images/AmongUs.png" class="card-img-top" style={{ width: "100%", height: "23rem" }} alt="..." />
                    <div class="card-body">
    <p class="card-text"></p>
  </div>
                </div>
